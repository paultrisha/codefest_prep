...
describe('WebexComponent', () => {
  ...
  it('Webex app should contain the input boxes and buttons', () => {
    ...
    fixture.whenStable().then(() => {
	  ...
	  expect(compiled.querySelector('#createRoom').textContent).toEqual('Create Room');
	  expect(compiled.querySelector('#addMember').textContent).toEqual('Add Member');
	  expect(compiled.querySelector('#sendMessage').textContent).toEqual('Send');
	  expect(compiled.querySelector('#logout').textContent).toEqual('Logout');
	  expect(compiled.querySelector('#webexRooms').textContent).toEqual('My test room ');
